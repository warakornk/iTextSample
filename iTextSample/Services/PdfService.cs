...
namespace iTextSample.Services
{
    public class PdfService : IPdfService
    {
        ...
        /// </summary>
        public async Task<string> Function_01()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_03()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_04()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_05()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_06()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_07()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_08()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_09()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_10()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_11()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_12()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_13()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_14()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_15()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_16()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_17()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_18()
        {
            string destinationPath = System.IO.Path.Combine(_environment.ContentRootPath, "Output");
            string saveFileName = $"{System.IO.Path.GetRandomFileName().Replace(".", "")}.pdf";
            string dest = System.IO.Path.Combine(destinationPath, saveFileName);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_19()
        {
            ...
            return await Task.FromResult("check folder output");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_20()
        {
            ...
            return await Task.FromResult("mergefile.pdf");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<string> Function_21()
        {
            ...
            return await Task.FromResult("filled_form.pdf");
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MemoryStream> Function_22()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MemoryStream> Function_23()
        {
            MemoryStream stream = new MemoryStream();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MemoryStream> Function_24()
        {
            MemoryStream stream = new MemoryStream();
            PdfWriter writer = new PdfWriter(stream);
            PdfDocument pdf = new PdfDocument(writer);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MemoryStream> Function_25()
        {
            MemoryStream stream = new MemoryStream();
            PdfWriter writer = new PdfWriter(stream);
            PdfDocument pdf = new PdfDocument(writer);
        ...
        /// <returns></returns>
        public async Task<List<SimpleSignatureInfomation>> Function_26(string filePath)
        {
            ...
            return await Task.FromResult(simpleSignatures);
        }
        ...
        /// <param name="filePath"></param>
        /// <returns></returns>
        public async Task<List<SimpleSignatureInfomation2>> Function_27(string filePath)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<MemoryStream> Function_29()
        {
            MemoryStream stream = new MemoryStream();
            PdfWriter writer = new PdfWriter(stream);
            PdfDocument pdf = new PdfDocument(writer);
            ...
            string sampleText = "What is Lorem Ipsum?\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.";
            Paragraph paragraph = new Paragraph(sampleText);
            ...
            float left = remaining.GetLeft();       // left position with margin
            float bottom = remaining.GetBottom();   // bottom position with margin
            float width = remaining.GetWidth();     // width of remaining area
            float height = remaining.GetHeight();   // height of remaining area
            float top = remaining.GetTop();         // top position of remaining area. Mean position after add paragraph at previos line

            // Print remaining area in next page
            document.Add(new AreaBreak());
            document.Add(new Paragraph($"left: {left}, bottom: {bottom}, width: {width}, height: {height}, top: {top}"));
